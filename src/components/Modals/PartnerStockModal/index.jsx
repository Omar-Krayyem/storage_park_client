...
const PartnerStockModal = ({ openModal, handleCloseModal, id }) => {
    ...
    const getOrder = async () => {
            await axios.get(`http://127.0.0.1:8000/api/partner/stock/${id}`, {
                headers: {
    ...
    return (
        <div>
            <Modal isOpen={openModal} className="PartnerStockModal"
            style={{
                overlay: {
